Сравнение прогонов: `faiss_500_nofilter__questions_tk_hard__base.jsonl` (base) и `faiss_500_nofilter__alekseevpavel04-multilingual-e5-small-ru-law_a095fa__questions_tk_hard__v2.jsonl` (ft-v2), вопросы `questions_tk_hard.jsonl`.
